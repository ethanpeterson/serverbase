...
module CreateSwapFileMatcher
  class CreateSwapFileMatcher
  ...
  def create_swap(expected_identity)
    CreateSwapFileMatcher.new(expected_identity)
  end
end

RSpec.configure do |config|
  config.include CreateSwapFileMatcher
end
